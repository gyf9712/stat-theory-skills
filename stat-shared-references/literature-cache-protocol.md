...
| `theory-sharpen` Steps 0.5B and 5 (Literature anchoring and benchmarking) | cache-consult; the relaxation pathways become cache-aware | router + applicability-axes | Lineage citations dominate here |
